...
<style>
	@media (max-width: 767px) {
		img[src="vendors/images/login-bg.png"] {
			display: none;
		}
	}
</style>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="vendors/images/login-bg.png" alt="" width="60%" />
				</div>
							...
							<div class="select-role">
								<div class="btn-group btn-group-toggle" data-toggle="buttons">
									<label class="btn active">
										...
										<div class="icon">
											<img src="vendors/images/briefcase.png" class="" alt="" />
										</div>
										<span>I'm</span>
										Advisor
									</label>
									...
									<label class="btn">
										...
										<div class="icon">
											<img src="vendors/images/person.png" class="" alt="" />
										</div>
										<span>I'm</span>
										Student
									</label>
