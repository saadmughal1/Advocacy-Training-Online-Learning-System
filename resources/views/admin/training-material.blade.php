...
@section('content')
    ...
    <div class="pd-20 card-box mb-30">
        ...
        <form action="{{ route('admin.add-training-material') }}" method="POST" enctype="multipart/form-data">
            @csrf
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary"
                                    href="{{ route('admin.download-training-material', ['id' => $material->id]) }}">
                                    Download
                                </a>
                            </td>
                            <td>
                                <form action="{{ route('admin.delete-training-material', ['id' => $material->id]) }}"
                                    method="POST"
