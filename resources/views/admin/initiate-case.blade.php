        ...
        <form action="{{ route('admin.initiate-family-law-case') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" type="file" name="step-1-video" />
                        @error('step-1-video')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Video Link</label>
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" type="file" name="step-7-video" />
                        @error('step-7-video')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Video Link</label>
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" type="file" name="step-9-video" />
                        @error('step-9-video')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Video Link</label>
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" type="file" name="step-10-video" />
                        @error('step-10-video')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Video Link</label>
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" type="file" name="step-11-video" />
                        @error('step-11-video')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Video Link</label>
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" type="file" name="step-12-video" />
                        @error('step-12-video')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
