<div class="pd-20 card-box mb-30">
    ...
    <div class="form-group row border p-3">
        ...
        <div class="col-sm-12 col-md-10">
            <p class=""><b>Case Title:</b> {{ $data['form-data']->case_title ?? 'Not Provided' }}</p>
            <p class=""><b>Citation Details:</b> {{ $data['form-data']->citation_details ?? 'Not Provided' }}</p>
        </div>
    </div>
    ...
    <div class="form-group row border p-3">
        ...
        <div class="col-sm-12 col-md-10">
            <p class=""><b>Headnote: Relevant laws:</b> {{ $data['form-data']->headnote_relevant_laws ?? 'Not Provided' }}</p>            
        </div>
    </div>
    ...
    <div class="form-group row border p-3">
        ...
        <div class="col-sm-12 col-md-10">
            <p class=""><b>Facts of the case:</b> {{ $data['form-data']->case_facts ?? 'Not Provided' }}</p>            
        </div>
    </div>
    ...
    <div class="form-group row border p-3">
        ...
        <div class="col-sm-12 col-md-10">
            <p class=""><b>Verdict of the court:</b> {{ $data['form-data']->court_verdict ?? 'Not Provided' }}</p>            
        </div>
    </div>
    ...
    <div class="form-group row border p-3">
        ...
        <div class="col-sm-12 col-md-10">
            <p class=""><b>Additional information:</b> {{ $data['form-data']->additional_info ?? 'Not Provided' }}</p>            
        </div>
    </div>
    ...
    <form action="{{ route('advisor.add-feedback-marks-family-law-case') }}" method="GET">
        ...
        <input type="hidden" class="form-control" name="step" value="4">
