<div class="pd-20 card-box mb-30">
    ...
    <div class="form-group row border p-3">
        ...
        <div class="col-sm-12 col-md-10">
            <p class=""><b>Introduction of the Reconciliator/Mediator:</b>
                {{ $data['form-data']->introduction_reconciliator ?? 'Not Provided' }}</p>
    ...
    <div class="form-group row border p-3">
        ...
        <div class="col-sm-12 col-md-10">
            <p class=""><b>Iindividual session</b>
                {{ $data['form-data']->individual_session ?? 'Not Provided' }}</p>
            <p class=""><b>Joint session:</b>
                {{ $data['form-data']->joint_session ?? 'Not Provided' }}</p>
        </div>
    </div>
