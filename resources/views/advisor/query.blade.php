...
@section('content')
    ...
    <div class="pd-20 card-box mb-30">
        ...
        <form action="{{ route('advisor.send-message') }}" method="POST">
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <textarea class="form-control w-100" placeholder="..." rows="5" readonly>{{ isset($messages) && $messages->isNotEmpty() ? $messages->first()->student_message : '' }}</textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-10">
                    <textarea class="form-control w-100" name="message" placeholder="Write Message Here..." rows="5">{{ isset($messages) && $messages->isNotEmpty() ? $messages->first()->advisor_message : '' }}</textarea>
                </div>
            </div>
