...
@section('page-title', 'Studet Feedback')
    ...
    @includeIf('advisor.partials._sidebar')
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form>
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Please provide your full name, date of birth and place
                        of birth:</label>
                    <div class="col-sm-12 col-md-10">
                        <p class="form-control">Lorem ipsum dolor sit amet.</p>
                        <p class="form-control">Lorem ipsum dolor sit amet.</p>
                        <p class="form-control">Lorem ipsum dolor sit amet.</p>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label"> Please provide your spouse’s full name, date and place
                        of birth, Social Security number, driver's license number:</label>
                    <div class="sm-12 col-md-10">
                        <p class="form-control">Lorem ipsum dolor sit amet.</p>
                        <p class="form-control">Lorem ipsum dolor sit amet.</p>
                        <p class="form-control">Lorem ipsum dolor sit amet.</p>
                    ...
                    <div class="sm-12 col-md-10 overflow-auto">
                        <table border="1" class="table">
                            ...
                            <tr>
                                ...
                                <th><input type="text" name="child2Name" class="form-control" placeholder="Name: ">
                                </th>
                                <th><input type="text" name="child2Sex" class="form-control" placeholder="Sex: ">
                                </th>
                                <th><input type="text" name="child2DOB" class="form-control" placeholder="D.O.B.:">
                                </th>
                            ...
                            <tr>
                                ...
                                <th><input type="text" name="child3Name" class="form-control" placeholder="Name: ">
                                </th>
                                <th><input type="text" name="child3Sex" class="form-control" placeholder="Sex: ">
                                </th>
                                <th><input type="text" name="child3DOB" class="form-control" placeholder="D.O.B.:">
                                </th>
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Special circumstances of children and/or
                        spouses:</label>
                    <div class="sm-12 col-md-10">
                        <p class="form-control">Lorem ipsum dolor sit amet.</p>
                        <p class="form-control">Lorem ipsum dolor sit amet.</p>
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">List all Retirement, Pensions, and Savings Plans: Do
                        you participate in any retirement plan or company savings plan?</label>
                    <div class="sm-12 col-md-10">
                        <p class="form-control">Lorem ipsum dolor sit amet.</p>
                    </div>
                </div>
        ...
        <div class="pd-20 card-box mb-30">
            <div class="clearfix mb-20 text-center">
                <div class="">
                    <h2 class="text-blue">Step 03: Searching Relevant Laws/Rules/Policies</h2>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Irreconcilable differences</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Enactment 1, Enactment 2</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Rule 1, Rule 2</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Case 1, Case 2, Case 3</p>
                </div>
            </div>
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Case Title Example</p>
                    <p class="form-control">Citation Details Example</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Headnote: Relevant laws example</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Facts of the case example</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Verdict of the court example</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Additional information example</p>
                </div>
            </div>
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Relief which the plaintiff claims</p>
                </div>
            </div>
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Introduction of the Reconciliator/Mediator</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Confidentiality assurance</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Individual session</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Joint session</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Neutrality/Impartiality</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Helped parties to change positions</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Helped parties to reach suggestions</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Helped parties to finalize suggestions</p>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <p class="form-control">Helped parties to reach agreement</p>
                </div>
            </div>
            ...
            <div class="container pt-4">
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody id="tbody">
                            <tr>
                                <td class="text-center">Example Issue of Law</td>
                                <td class="text-center">Example Onus to Prove</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <!-- <button class="btn btn-md btn-primary" id="addBtn" type="button">Add new Issue Law</button> -->
            </div>
            ...
            <div class="container pt-4">
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody id="tbody">
                            <tr>
                                <td class="text-center">Example Issue of Fact</td>
                                <td class="text-center">Example Onus to Prove</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <!-- <button class="btn btn-md btn-primary" id="addBtn" type="button">Add new Fact Law</button> -->
            </div>
            ...
            <form action="">
                ...
                <div class="clearfix mb-20">
                    <div class="pull-left">
                        <h5 class="text-blue">Instructions:</h5>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus minima amet totam, quasi
                            vel consequuntur.
                        </p>
                    </div>
                </div>
                ...
                <div class="clearfix mb-20 text-center">
                    <div>
                        <h5 class="text-blue text-center">Role Play Video</h5>
                        <video class="w-100" src="../vendors/documents/videos/demo.mp4" controls
                ...
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Add your feedback</label>
                    <div class="sm-12 col-md-10">
                        <p class="form-control">Pellentesque habitant morbi tristique senectus et netus et malesuada fames
                            ac turpis egestas. Nam quis dolor ac mauris posuere congue. Nullam quis tortor vel tellus
                            ultricies lacinia.</p>
                    </div>
                </div>
        ...
        <div class="pd-20 card-box mb-30">
            <form action="">
                <div class="clearfix mb-20 text-center">
                    <div class="">
                        <h2 class="text-blue">Step 13: Judgement</h2>
                    </div>
                </div>
