...
@section('content')
    ...
    <div class="pd-20 card-box mb-30">
        ...
        <form action="{{ route('advisor.add-resource') }}" method="POST">
            @csrf
                ...
                <tbody>
                    @foreach ($resources as $index => $resource)
                        <tr>
                            ...
                            <td>
                                <a
                                    href="{{ route('advisor.edit-resource', ['id' => $resource->id, 'caseId' => $caseId]) }}">
                                    <span class="badge badge-primary border-0">Edit</span>
                                </a>
                            </td>
                            <td>
                                <form
                                    action="{{ route('advisor.delete-resource', ['id' => $resource->id, 'caseId' => $caseId]) }}"
                                    method="POST"
