    ...
    <div class="pd-20 card-box mb-30">
        ...
        <form action="">
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    ...
                    <textarea class="form-control"
                        placeholder="Enter the name, description and place of residence of the defendant, so far as they can be ascertained"></textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <textarea class="form-control"
                        placeholder="Such as: suit for dissolution of marriage, suit for recovery of maintenance etc. "></textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="sm-12 col-md-10">
                    <textarea class="form-control"
                        placeholder="Giving the number of witnesses intended to be produced in support of the written statement "></textarea>
                    <textarea class="form-control"
                        placeholder="Enter the names and addresses of the witnesses and brief summary of the facts to which they would depose"></textarea>
                </div>
            </div>
